...
const AboutPage = () => {
	...
	return (
		...
		<OuterSpacer>
			...
			<p>
				This project is my submission for Assignment 2 of CPSC 455, which is a simple website built using React.js, and CSS. As per requirements, every page has a navbar, and loads CSS from external files. Additionally, the site is built to be responsive through the use of &lt;meta&gt; tags and media queries, as well as flex containers for displaying team member cards. Additionally, there is a JSON string used initialize the starting team members, as well as list used to store team members (shared across pages using <em>sessionStorage</em>). One interesting thing I tried to implement was the dynamic setting of a card&apos;s background colour, based on the average colour of the corresponding member&apos;s photo!
			</p>
		</OuterSpacer>
		</>
	);
